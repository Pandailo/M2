  ...
  public static void main(String[] args) throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      if (msg instanceof TextMessage)
        System.out.println("Msg received from modified receiver: " + ((TextMessage) msg).getText());
      else if (msg instanceof ObjectMessage)
        System.out.println("Msg received from modified receiver: "
                           + ((ObjectMessage) msg).getObject());
      else
        System.out.println("Msg received from modified receiver: " + msg);
    }
