...
public class DMQSelect {
  public static void main(String[] args) throws Exception {
    ...
    MessageConsumer consumer = session.createConsumer(dmq, "JMSDestination = 'Queue[#0.0.1028]'");
    ...
    do {
      ...
      System.out.println("\nreceives: \"" + msg.getJMSMessageID() + "\" from " + msg.getJMSDestination() +
